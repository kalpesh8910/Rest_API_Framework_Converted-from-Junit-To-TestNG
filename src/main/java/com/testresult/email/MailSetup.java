...
public class MailSetup {
	...
	public void sendTestResultMailwithAttachments() {
		String From = "prajapatikalpesh8910@gmail.com";
		String To = "prajapatikalpesh8910@gmail.com";
		String Password = "cumuaipwmbnnajtu";
...
//		String FilePath = System.getProperty("user.dir") + "/test-output/AutomationReports/TestExecutionReport.html";
		String FilePath = System.getProperty("user.dir") + "/test-output/AutomationReports/ExecutionReport.html";	
